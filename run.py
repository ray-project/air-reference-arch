...
# Train model (using offline feature store for zipcode and credit history features)
if not model.is_model_trained():
    model.train(loans)

# Make online prediction (using Online feature store for retrieving online features)
loan_request = {
    "zipcode": [76104],
